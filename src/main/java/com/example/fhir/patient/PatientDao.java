...
import com.example.fhir.patient.entities.Name;
import com.example.fhir.patient.entities.PatientEntity;
import com.example.fhir.patient.entities.Telecom;
import com.example.fhir.patient.transform.PatientEntityToFHIRPatient;
...
public class PatientDao implements IPatient {
    ...
    public Patient create(FhirContext ctx, Patient patient) {
        ...
        for (Identifier identifier : patient.getIdentifier()) {
            com.example.fhir.patient.entities.Identifier identifierE = new com.example.fhir.patient.entities.Identifier();
        ...
        for (Address address : patient.getAddress()) {
            com.example.fhir.patient.entities.Address addressEntity = new com.example.fhir.patient.entities.Address();
